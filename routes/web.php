...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/send-otp/{id}', [RegisterController::class, 'sendOtp'])->name('send.otp');
...
Route::middleware(['auth', 'check.status','check.takedown'])->group(function () {
    ...
    Route::get('/user/create-post', [UserController::class, 'createPost'])->name('user.createPost');
    ...
    Route::post('/reports/post', [ReportController::class, 'submitReportPost'])->name('reports.post.submit');
    ...
    Route::post('/reports/products', [ReportController::class, 'submitReport'])->name('reports.products.submit');
    ...
    Route::prefix('messages')->group(function () {
        ...
        Route::get('/{conversation}', [MessageboxController::class, 'show'])->name('message.show'); // Menampilkan pesan dalam percakapan
        Route::post('/{conversation}/send', [MessageboxController::class, 'sendMessage'])->name('message.send'); // Mengirim pesan
    });
