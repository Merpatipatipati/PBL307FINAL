...
document.addEventListener('DOMContentLoaded', function () {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].defaults.headers.common['X-CSRF-TOKEN'] = csrfToken;
  var chatDataElement = document.getElementById('chat-data');
  if (!chatDataElement) {
    console.error('Chat data element not found!');
    return;
  }
  var username = chatDataElement.getAttribute('data-username');
  var conversationId = chatDataElement.getAttribute('data-conversation-id');
  var userId = parseInt(chatDataElement.getAttribute('data-user-id'));
  var EchoInstance = new laravel_echo__WEBPACK_IMPORTED_MODULE_0__["default"]({
  ...
  EchoInstance["private"]("conversation.".concat(conversationId)).listen('MessageSent', function (data) {
  ...
  function addMessageToUI(data, isSender) {
    ...
    messageDiv.innerHTML = "\n            <div class=\"".concat(isSender ? 'text-right' : 'text-left', "\">\n                <p class=\"mb-1\"><strong>").concat(data.sender, "</strong></p>\n                <p class=\"bg-light p-2 rounded d-inline-block\">\n                    ").concat(data.message, "\n                </p>\n                <small class=\"text-muted d-block\">").concat(data.timestamp, "</small>\n            </div>\n        ");
    messagesBox.appendChild(messageDiv);
  }

  // Fungsi untuk mengirim pesan
  function sendMessage(content) {
    return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/api/conversations/".concat(conversationId, "/messages"), {
      content: content
      ...
      var _error$response;
      console.error('Send message error:', ((_error$response = error.response) === null || _error$response === void 0 ? void 0 : _error$response.data) || error.message);
      alert('Failed to send message. Please try again.');
    });
  }

  // Event listener untuk form kirim pesan
  (_document$getElementB = document.getElementById('message-form')) === null || _document$getElementB === void 0 || _document$getElementB.addEventListener('submit', function (e) {
    var _document$getElementB2;
    e.preventDefault();
    var content = (_document$getElementB2 = document.getElementById('message-content')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.value.trim();
    if (!content) {
      alert('Message cannot be empty!');
      return;
    }
    var sendButton = e.target.querySelector('button[type="submit"]');
    sendButton.disabled = true;
    sendMessage(content)["finally"](function () {
